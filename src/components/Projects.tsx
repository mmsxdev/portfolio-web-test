...
const projects: Project[] = [
  {
    ...
    description: 'Uma plataforma completa de e-commerce com sistema de pagamento, gestão de produtos e área do cliente.',
  ...
  },
  {
    ...
    description: 'Aplicativo de gerenciamento de tarefas com recursos de colaboração, notificações e integrações.',
  ...
  },
  {
    ...
    description: 'Plataforma imobiliária com busca avançada, mapa interativo e sistema de agendamento de visitas.',
  ...
  },
  {
    ...
    description: 'Dashboard financeiro com visualizações de dados, relatórios e previsões baseadas em IA.',
      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          {project.tags.map((tag, index) => (
            <span 
              key={index} 
              className="bg-slate-700 text-highlight text-xs px-2 py-1 rounded-full"
            >
              {tag}
            </span>
          ))}
        ...
        <div className="flex justify-between">
          {project.github && (
            <a href={project.github} className="flex items-center text-slate-300 hover:text-highlight transition-colors">
          ...
          {project.live && (
            <a href={project.live} className="flex items-center text-slate-300 hover:text-highlight transition-colors">
